...
static const GuiStyleProp lavandaStyleProps[LAVANDA_STYLE_PROPS_COUNT] = {
    { 0, 0, static_cast<int>(0xab9bd3ff) },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, static_cast<int>(0x3e4350ff) },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, static_cast<int>(0xdadaf4ff) },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 3, static_cast<int>(0xee84a0ff) },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, static_cast<int>(0xf4b7c7ff) },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, static_cast<int>(0xb7657bff) },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, static_cast<int>(0xd5c8dbff) },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, static_cast<int>(0x966ec0ff) },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, static_cast<int>(0xd7ccf7ff) },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, static_cast<int>(0x8fa2bdff) },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, static_cast<int>(0x6b798dff) },    // DEFAULT_BASE_COLOR_DISABLED 
    { 0, 11, static_cast<int>(0x8292a9ff) },    // DEFAULT_TEXT_COLOR_DISABLED 
    { 0, 16, static_cast<int>(0x00000010) },    // DEFAULT_TEXT_SIZE 
    { 0, 18, static_cast<int>(0x84adb7ff) },    // DEFAULT_LINE_COLOR 
    { 0, 19, static_cast<int>(0x5b5b81ff) },    // DEFAULT_BACKGROUND_COLOR 
